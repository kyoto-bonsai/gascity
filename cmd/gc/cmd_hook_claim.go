...
const (
	...
	// hookClaimReasonClaimConflict reports a by-ID refusal where
	// hookClaimAlreadyHeldCollision found a genuine lost race against a live
	// sibling this session WAS eligible to claim — the counterpart to
	// hookClaimReasonNotClaimable's never-eligible case (ga-64l8t8 validation
	// F3; see writeHookClaimByIDRefused).
	hookClaimReasonClaimConflict = "claim_conflict"
)
